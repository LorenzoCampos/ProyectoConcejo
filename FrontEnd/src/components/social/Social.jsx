...
function Social() {
  return (
    ...
    <a href="https://www.instagram.com/concejoarroyoseco/">
      <svg className= "responsive-svg" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
    ...
    <a href="https://www.facebook.com/concejoarroyoseco">
      <svg className= "responsive-svg" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
    ...
    <a href="https://www.youtube.com/@ConcejoArroyoSeco">
    <svg className= "responsive-svg" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
