...
return [
    ...
    'attributes'           => [
        ...
        // Atributos para la normativa
        'type' => 'Tipo de normativa',
        'number' => 'Número de Cargo',
        'state' => 'Estado',
        'date' => 'Fecha',
        'subject' => 'Tema',
        'pdf_process' => 'PDF de la normativa en proceso',
        'pdf_approved' => 'PDF de la normativa aprobada',
        'modifies' => 'Norma/s a la que modifica',
        'modifies.*' => 'Norma/s a la que modifica',
        'modified_by' => 'Norma/s que la modifican',
        'modified_by.*' => 'Norma/s que la modifican',
        ...
        'last_name' => 'Apellido',
        'email' => 'Email',
        'email_confirmation' => 'Confirmación del Email',
        'password' => 'Contraseña',
